...
class GameManagerDoodle(Script):
    ...
    def update(self, screenResolution: pygame.Vector2, gameObjHandl: GameObjectHandler):
        #delta = pygame.Vector2(0, abs(self.prevDelta.y - gameObjHandl.getObjectByTag("Player").getPosition().y))
        delta = pygame.Vector2(0, 2)
    ...
    def lateUpdate(self, gameObjHandl: GameObjectHandler):
        ...
        text = font.render("Height: " + str(int(-player.getPosition().y)), True, "black")
